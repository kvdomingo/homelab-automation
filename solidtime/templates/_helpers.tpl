...
{{- define "solidtime-scheduler.labels" -}}
helm.sh/chart: {{ include "solidtime.chart" . }}
{{ include "solidtime-scheduler.selectorLabels" . }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
...
{{- define "solidtime-queue.labels" -}}
helm.sh/chart: {{ include "solidtime.chart" . }}
{{ include "solidtime-queue.selectorLabels" . }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
...
{{- define "solidtime-scheduler.selectorLabels" -}}
app.kubernetes.io/name: '{{ include "solidtime.name" . }}-scheduler'
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}

{{- define "solidtime-queue.selectorLabels" -}}
app.kubernetes.io/name: '{{ include "solidtime.name" . }}-queue'
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}
